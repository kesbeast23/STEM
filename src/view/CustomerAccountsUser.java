 ...
 * @author Kesego
 */
public class CustomerAccountsUser extends javax.swing.JFrame {

    /**
     * Creates new form CustomerAccounts
     */
    public CustomerAccountsUser() {
        initComponents();
         table_update();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerAccountsUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerAccountsUser().setVisible(true);
            }
        });
    }
